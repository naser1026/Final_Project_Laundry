...
class KasirController extends Controller
{
    public function index()
    {
        ...
        try {
            ...
            $result = $result['data']['cashiers'];

            // return response()->json([
            //         'cashiers' =>  $result
            // ], );

            return view('settings-pages.pengaturan-kasir')->with('cashiers', $result);
    ...
    public function create(Request $request)
    {
        ...
        $response = $client->post(env('API_URL') . '/api/cashier', [
            'headers' => [
                'Authorization' => $user['token'],
        ...
        return redirect('/pengaturan-kasir');
    }
    ...
    public function edit(Request $request)
    {
        ...
        // Lakukan POST request
        $response = $client->put(env('API_URL') . '/api/cashier/' . $request->id, [
            'headers' => [
                'Authorization' => $user['token'],
                'Content-Type' => 'application/json',
                'Accept' => 'application/json',
    ...
    public function delete($id)
    {
        ...
        // Lakukan POST request
        $response = $client->delete(env('API_URL') . '/api/cashier/' . $id, [
            'headers' => [
                'Authorization' => $user['token'],
                'Content-Type' => 'application/json',
                'Accept' => 'application/json',
