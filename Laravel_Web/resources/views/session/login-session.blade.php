            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  ...
                  <p class="mb-0">Memantau Usaha Laundry Anda Dimanapun dan Kapanpun <br></p>
                  <br>
                  <br>
                  <p class="mb-0 text-center"><strong>Masuk / Daftar dengan</strong><br></p>
                </div>
              ...
              <div class="col-3 me-auto px-1">
                <a class="btn btn-outline-light w-100" href="javascript:;">
                  ...
                  <form role="form" method="POST" action="/handle-login">
                    @csrf
                    <label>Email</label>
                    <div class="mb-3">
                      <input type="email" class="form-control" name="email" id="email" placeholder="Email" value="owner@mail.com" aria-label="Email" aria-describedby="email-addon">
                      @error('email')
                    ...
                    <div class="mb-3">
                      <input type="password" class="form-control" name="password" id="password" placeholder="Password" value="owner123" aria-label="Password" aria-describedby="password-addon">
                      @error('password')
                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                      @enderror
                    </div>
                ...
                <small class="text-muted">Lupa kata sandi? Atur ulang kata sandi anda
